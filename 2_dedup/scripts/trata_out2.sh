#!/bin/bash
# -------------------------------------------------------------------------- #
# trata_out2.sh - Checa se os registro estão duplicados utilizando o DeDup  #
# -------------------------------------------------------------------------- #
#
#     Chamada : trata_out2.sh
#     Exemplo : ./trata_out2.sh <Diretorio> <iso-8859-1/utf-8>
#
#
# -------------------------------------------------------------------------- #
...
cd $DIRWRK/$1
        ...
        $DIRISIS/mx seq=$DIRWRK/$1/out2_$1_$2.txt create=$DIRWRK/$1/out2_$2 -all now tell=5000

        echo "Inverte"
        $DIRISIS/mx $DIRWRK/$1/out2_$2 "fst=3 0 v3/" fullinv=$DIRWRK/$1/out2_$2 tell=5000
