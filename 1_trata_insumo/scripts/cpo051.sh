...
echo "Relatorio que registros fora do padrão"
$DIRISIS/mx $3_2 "pft=if p(v9) and a(v909) then v2'|'v9/ fi" -all now >$DIROUTS/$1/Rel_$3.txt
$DIRISIS/mx $3_2 "tab=if p(v9) and a(v909) then v9/ fi" -all now  >$DIROUTS/$1/Lista_$3.txt
