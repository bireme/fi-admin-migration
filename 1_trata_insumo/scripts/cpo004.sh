...
$DIRISIS/mx $2 "proc=,if s(mpu,v4,mpl):'LILACS' then '<950>LILACS</950>' fi" "proc='d904',if p(v4) then (if s(mpu,v4,mpl)='LILACS' then else '<904 0>'v4'</904>' fi),fi" create=$3_1 -all now
