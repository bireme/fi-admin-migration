...
$DIRISIS/mx $3_1 "proc='d908',(if s(mpu,v8^*,mpl)='CD-ROM' or s(mpu,v8^*,mpl)='CR-ROM' then if p(v8^i) or p(v8^a) then '<938 0>^aCD-ROM</938>','<995 0>Inf. do CD-ROM: 'if p(v8^i) then v8^i else v8^a fi'</995>' else '<938 0>^aCD-ROM</938>' fi, else if s(mpu,v8^*,mpl)='DISQUETE' then '<938 0>^aDisquete</938>', else if size(v8)>22 then if s(mpu,v8,mpl):'INTERNET' and p(v8^i) then '<908 0>^u'v8^i'</908>' else if size(v8^i)>3 then '<908 0>^u'v8^i'</908>' else |<908 0>|v8|</908>| fi,fi,fi,fi,fi)" create=$3_2 -all now
...
$DIRISIS/mx $3_2 "proc='d908',(if p(v908^u) then if s(mpu,v908^*,mpl):'PDF' then '<908 0>^u'v908^u,'^yPDF^qpdf','^i',if p(v908^i) then v908^i else v940[1] fi,|^g|v908^g,|^s|v908^s'</908>' else if s(mpu,v908^*,mpl):'HTM' then '<908 0>^u'v908^u,'^yHTM^qhtm','^i',if p(v908^i) then v908^i else v940[1] fi,|^g|v908^g,|^s|v908^s'</908>' else if s(mpu,v908^*,mpl):'PHP' then '<908 0>^u'v908^u,'^yHTM^qphp','^i',if p(v908^i) then v908^i else v940[1] fi,|^g|v908^g,|^s|v908^s'</908>' else '<908 0>^u'v908^u,|^q|v908^q,|^y|v908^y,'^i',if p(v908^i) then v908^i else v940[1] fi,|^g|v908^g,|^s|v908^s'</908>' fi,fi,fi, else if p(v908) then if v908:'^' then  '<908 0>'v908'</908>' else if s(mpu,v908^*,mpl):'PDF' then '<908 0>^u'v908,'^yPDF^qpdf','^i',if p(v908^i) then v908^i else v940[1] fi,|^g|v908^g,|^s|v908^s'</908>' else '<908 0>^u'v908,'^yHTM^qhtm','^i',if p(v908^i) then v908^i else v940[1] fi,'</908>' fi,fi,fi, fi)" create=$3_3 -all now tell=5000
