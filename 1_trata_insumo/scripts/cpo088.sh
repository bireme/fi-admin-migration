...
$DIRISIS/mx $3_1 "proc=if p(v88) then ,(if s(mpu,v88.2,mpl)='^D' then if v88.2='^D' then '<988 0>^d'v88*2'</988>' else '<988 0>'v88'</988>' fi, else if v88.1='^' then '<988 0>^d'v88*1'</988>' else '<988 0>^d'v88'</988>' fi,fi)fi" create=$3_2 -all now

$DIRISIS/mx $3_2 "proc='S'" create=$3 -all now tell=5000

$DIRISIS/mx $3 "proc='d*',if p(v988) then |<2 0>|v2|</2>|,(|<988>|v988|</988>|) fi" iso=$DIRWORK/$1/$3.iso -all now tell=5000
